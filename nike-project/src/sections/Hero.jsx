...
const Hero = () => {
  ...
  return (
    <section id="home" className="className='w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container">
      ...
      <div className="relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-300 bg-hero bg-cover bg-center">
        ...
        {/* Cards que realizam as transições */}
        <div className="flex sm:gap-6 absolute -bottom-[5%] sm:left-[10%]">
          {shoes.map((shoe) => 
          (
            <div>
              <ShoeCard
